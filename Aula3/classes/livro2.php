...
<table class="table table-borderless">
        ...
        <tbody>
        <tr>
            <td>ISBN: <?= $isbnlivro2?></td>
        </tr>
        <tr>   
            <td>Título: <?= $titulolivro2?></td>
        <tr>
            <td>Num. Páginas: <?= $nPaginasLivro2?></td>
        </tr>
        <tr>
            <td>Edição: <?= $NumEdicaoLivro2?></td>
        </tr>
        <tr>   
            <td>Editora: <?= $nomeeditora1?></td>
        <tr>
            <td>Autor: <a href="autor1.php"><?= $nomeautor1?></a></td>
        </tr>
        <tr>
            <td>Ano: <?= $anoPublicacaoLivro2?></td>
        </tr>   
        </tbody>
      </table>
